...
console.log(` ${chalk.dim('1.')} Editing the new ${chalk.green('gulp.config.js')} file to specify your theme structure.`);
console.log(` ${chalk.dim('2.')} Remove the old gulp.config.${chalk.red('json')} from the older Woodoo Buildtools Version`);
console.log(` ${chalk.dim('3.')} Run ${chalk.green('npm run woodoo-init')} to complete the Woodoo Buildtools installation.`, '\n');
