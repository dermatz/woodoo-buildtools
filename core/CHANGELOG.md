...
## Latest Release
### [2.7.0](https://gitlab.com/dermatz/woodoo-buildtools/-/releases)
Please Update your gulpfile after update!
Search `const eslint = require('gulp-eslint');` and replace with `const eslint = require('gulp-eslint');`

>- update npm dependencies
>- replace`gulp-eslint` with `gulp-eslint7` to get es2021 compatibility - please update existing requirements in your gulpfile.js.
>- `jpegtran`not longer supported in image minification task. (support will be check)
>- Remove entry in the setup process

### [2.6.2](https://gitlab.com/dermatz/woodoo-buildtools/-/releases)
>- update npm dependencies
